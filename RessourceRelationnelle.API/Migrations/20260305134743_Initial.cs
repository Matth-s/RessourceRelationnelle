    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DemographicsZone", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    TypeRelation = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    TypeRessource = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeResources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Event_DemographicsZone_DemographicZoneId",
                        column: x => x.DemographicZoneId,
                        principalTable: "DemographicsZone",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Event_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shared", x => new { x.UserId, x.ResourceId });
                    table.ForeignKey(
                        name: "FK_Shared_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shared_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitationStatus = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participations", x => new { x.UserId, x.SessionId });
                    table.ForeignKey(
                        name: "FK_Participations_ActiveSessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActiveSessions_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DemographicZoneId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_DemographicZoneId",
                table: "Event",
                column: "DemographicZoneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_TypeRelationId",
                table: "Resources",
                column: "TypeRelationId");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_TypeRessourceId",
                table: "Resources",
