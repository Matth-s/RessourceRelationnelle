        ...
        <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-3 md:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link to="/" className="block text-sm text-gray-400 hover:text-white">
                Accueil
              </Link>
              <Link to="/resources" className="block text-sm text-gray-400 hover:text-white">
                Ressources
              </Link>
              <Link to="/help" className="block text-sm text-gray-400 hover:text-white">
                Aide
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="mailto:contact@resources-relationnelles.fr"
